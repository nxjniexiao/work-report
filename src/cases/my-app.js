(function (angular) {
  angular.module("myApp", ['tm.pagination']).controller("myController", [
    ...
    function ($scope) {
      ...
      $scope.listArray = arr;
      $scope.filterListArray = function () {
        const {currentPage, itemsPerPage} = $scope.paginationConfig;
        $scope.partialListArray = $scope.listArray.slice((currentPage - 1) * itemsPerPage, (currentPage - 1) * itemsPerPage + itemsPerPage);
